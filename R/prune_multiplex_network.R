...
#'
#' @param network data frame containing the edge list of a network with two columns containing nodes ids and one column named weight containing edge weights
